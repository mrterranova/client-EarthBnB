...
export class BrianTtdComponent implements OnInit {
  ...
  constructor(private ttdService: PhotosService, private route: ActivatedRoute) { }
  ...
  getLocationByID(id: number) {
    this.ttdService.getLocationByID(id).subscribe(
      data => {
        this.location = data; 
  ...
  getTTDs(state) {
    this.ttdService.getTTds().subscribe(
